			...
			<div class="container max-height">
				<div class="col-sm-5 footer-sub equal-height no-padding">
					...
					<p>
						...
						?>
						<a href="<?php echo base_url('home/about_view');?>" class="btn">Read More</a>
					</p>
					</div>
				</div>
		...
		<?php
    		$copytext = $this->db->get('footer_copyright');
    		$copytext = $copytext->result_array();
