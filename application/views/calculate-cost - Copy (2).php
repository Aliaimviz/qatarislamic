...
<div class="col-sm-10 other-bordered">
...
<div class="col-sm-7 no-padding cost-banner">
<div class="col-sm-12 ">
...
<div class="col-sm-3 no-padding">
		...
		?>
		<label>
		<input type="radio" text="Turnkey" name="turnkey" id="turnkey" value="<?php echo $cal['skeleton']?>" onchange="GetSelectedVal(this);" class="form-control">
		<span class="custom-radio-space">Skeleton</span>
		</label>
        <label>
        <input type="radio" text="Turn Key" name="turnkey" id="turnkey" value="<?php echo $cal['turnkey']?>" onchange="GetSelectedVal(this);" class="form-control">
        <span class="custom-radio-space">TurnKey</span>
        </label>
		</div>
...
font-size: 12px;
font-style: inherit;
">(Kindly Select Any One Of Construction Type For Making Project Calculations Before Clicking Calulate Button)</b>
        <?php
        	}
        ?>
	</div>
...
<div class="hidebox">
	<div class="row custom-margin-form">
		...
		<div class="row custom-margin-form">
			...
			<div class="col-sm-6  col-xs-6 custom-cost-margin calulates-result-generated">:<input type="text" value="" class="form-control transparent-field" id="arearesult" name="arearesult">
			</div>
		</div>
...
<!-- section-calulate-content -->
		<section class="content-heading">
			<div class="container">
				...
				<div class="quote" style="background: maroon;height: 36px;margin-bottom: 15px;"><h3 style="color:white">Quote your Page</h3></div>
