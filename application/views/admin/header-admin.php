		...
		<header class="admin-header blacked">
			<div class="container">
				...
				<div class="col-sm-5 col-md-4 user">
					<text><span>Welcome, User</span></text>
					<text><span><a href="<?php echo base_url('home/index');?>">Site Preview</a></span></text>
					<text><a href="<?php echo base_url('login/logout');?>">Sign Out</a></text>
