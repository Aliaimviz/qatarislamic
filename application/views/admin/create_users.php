		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
					<h2 class="pink-md-heading">Create Admin By Super Admin Account</h2>
					<?php echo form_open_multipart('create_users_controller/insert_users') ?>
						<div class="form-group">
							<input type="text" class="form-control" name="user_email" placeholder="Enter User Email Here" required>
						</div>
						
						<div class="form-group">
							<input type="password" class="form-control" name="user_password" placeholder="Enter User Password Here" required>
						</div>
