...
<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
					<h2 class="pink-md-heading">Add Caluclator Value</h2>
					<?php echo form_open_multipart('calculatorcontroller/insert')?>
					<?php
				    	$data = $this->db->get('calculator');
				    	$data = $data->result_array();
							foreach($data as $datas){
		    		?>
							<div class="form-group">
								<label>Skeleton</label>
								<input type="text" class="form-control" name="skeleton" value="<?php echo $datas['skeleton']?>">
							</div>
							<div class="form-group">
								<label>Turnkey</label>
								<input type="text" class="form-control" name="turnkey" value="<?php echo $datas['turnkey']?>">
							</div>
