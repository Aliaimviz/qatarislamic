		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
						<h2 class="pink-md-heading">Upload Active Projects</h2>
						<?php echo form_open_multipart('admincontroller/insertDB2');?>
						<div class="col-sm-6 form-input-padding-left">
							<div class="form-group">
								<input type="file" id="file-upload2" name="myfile2" style="display: none;" required>
								<label for="file-upload2" class="btn form-control file-upload rounded"><span class="image"><i class="fa fa-picture-o" aria-hidden="true"></i></span>Choose File</label>
							</div>
						</div>	
						...
						<div class="form-group">
						  ...
						  <button type="submit" value="upload2" class="btn btn-primary">Upload Image For Active Projects</button>
					<?php echo form_close() ?>
				</div>
			</div>
		</section>	
