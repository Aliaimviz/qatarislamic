<?php include ('header-admin.php');?>
	<section class="admin-content">
			...
			<div class="col-sm-9 col-md-9 form">
				...
				<center>
						<h2 class="pink-md-heading">Delete Admin Accounts</h2>
				</center>
				<table class="table table-striped web-act">
				  	<thead>
				      <tr>
				     	<th class="user-email">User Email</th>
				     	<th class="user-date-time">User Password</th>
				        <th class="user-date-time">Action</th>
					...
					<tbody>
					    <tr>
					    <td class="user-email"><?php echo $rows['user_email']?></td>
					    <td class="user-date-time"><?php echo $rows['user_password']?></td>
					    <td class="user-date-time"><a type="submit" href="<?php echo base_url().'create_users_controller/delete/'.$rows['id']?>" class="btn btn-primary">Delete</a></td>
