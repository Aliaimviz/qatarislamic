		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
					...
					<?php echo form_open_multipart('meta/insert_homemeta/'); ?>
					<?php
					...
					<div class="form-group">
						<textarea class="form-control" rows="6" placeholder="Enter Meta Keywords Here" name="meta_keywords" value="<?php echo $datas['meta_keywords']?>"><?php echo $datas['meta_keywords']?></textarea>
					</div>
					<div class="form-group">
						<textarea class="form-control" rows="6" placeholder="Enter Meta Description Here" name="meta_description" value="<?php echo $datas['meta_description']?>"><?php echo $datas['meta_description']?></textarea>
					</div>
					...
					<!--Main Banner of Home Page Start Here-->
					<br><br><br><br><br><br><br><br><br><h2 class="pink-md-heading">Main Banner of Home Page</h2>
					<?php echo form_open_multipart('pagesortingcontroller/hometop/'); ?>
					<?php
					...
					<div class="form-group">
						<textarea class="form-control" rows="6" placeholder="Enter Banner Description Here" name="description" value="<?php echo $datas['description']?>"><?php echo $datas['description']?></textarea>
					</div>
					<button type="submit" name="submit" class="btn btn-primary">Submit</button>
					<?php
						}
					?>	
					<?php echo form_close();?>
					<!--Main Banner of Home Page End Here-->
