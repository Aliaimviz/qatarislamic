		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
					...
					<?php echo form_open_multipart('meta/insert_contactusmeta/');?>
					<?php
					...
					<!--Bottom Content Of Contact Us Page Start Here-->
					<br><br><br><br><br><br><br><br><br><h2 class="pink-md-heading">Bottom Content Of Contact Us Page</h2>

					<?php echo form_open_multipart('pagesortingcontroller/contacttop/');?>
					<?php
			    		$data = $this->db->get('contacttop');
			    		$data = $data->result_array();
							foreach($data as $datas) {
		    		?>
					<div class="form-group">
						<input type="text" class="form-control" name="heading" placeholder="Enter Heading Of Bottom Content Here" value="<?php echo $datas['heading']?>">
					</div>
					<div class="form-group">
						<textarea class="form-control" rows="6" placeholder="Enter Description Of Bottom Content Here" name="description"><?php echo $datas['description']?></textarea>
					</div>
					<button type="submit" name="submit" class="btn btn-primary">Submit</button>
					<?php
						}
