		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
					<h2 class="pink-md-heading">Add service 1</h2>
					<?php echo form_open_multipart('adservicescontroller/insert1/'); ?>
					<?php
		    		...
		    		?>
						<div class="form-group">
							<input type="text" class="form-control" name="service_name1" value="<?php echo $datas['name1']?>">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="service_subheading" value="<?php echo $datas['subheading1']?>">
						</div>
						<div class="form-group">
								<textarea class="form-control" rows="6" name="service_description1"><?php echo $datas['description1']?></textarea>
						</div>
