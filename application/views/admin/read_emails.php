...
include ('header-admin.php');?>
	<section class="admin-content">
			<div class="container">
				<div class="col-sm-3 col-md-3 left-side left-sidde">
					<ul>
				...
				<div class="col-sm-9 col-sm-9  form read-email">
				<h2 class="pink-md-heading">Read Emails</h2>
            	...
            	<table class="table table-striped " style="display: inline-block;">
					<thead>
				      <tr>
				        <th class="read-email">User Email</th>
				        <th class="read-name">User Name</th>
				        <th class="read-phone">User Phone</th>
				        <th class="read-subject">User Subect</th>
				        <th class="read-message">User Message</th>
			...
			<tbody>
		      	<tr>
		      		<td class="read-email"><?php echo $rows['email']?></td>
			        <td class="read-name"><?php echo $rows['name']?></td>
			        <td class="read-phone"><?php echo $rows['phone']?></td>
			        <td class="read-subject"><?php echo $rows['subject']?></td>
			        <td class="read-message"><p class="msg-scr"><?php echo $rows['message']?></p></td>
			    </tr>
			</tbody>
			<?php	
				}
