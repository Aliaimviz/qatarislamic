		...
		<header class="admin-header blacked">
			<div class="container">
				...
				<div class="col-sm-5 col-md-4 user">
					<text><span>Welcome To Qatar Islmaic Admin Panel</span></text>					
				</div>
			</div>
		</header>	
		<!-- header-ended -->
				...
				<div class="col-sm-offset-3 col-sm-6  form signin">
						...
						<?php echo form_open_multipart('login/login');?>
							<div class="form-group">
								<input type="email" class="form-control" name="username" id="username" placeholder="Enter Email Address Here For Login" required>
							</div>
							<div class="form-group">
								<input type="password" class="form-control" name="password" id="password" placeholder="Enter Password Here For Login" required>
							</div>
