		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
					<h2 class="pink-md-heading">Add service 2</h2>
					<?php echo form_open_multipart('adservicescontroller/insert2/'); ?>
					<?php
		    		...
		    		?>
						<div class="form-group">
							<input type="text" class="form-control" name="service_name" value="<?php echo $datas['name2']?>">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="service_subheading" value="<?php echo $datas['subheading2']?>">
						</div>
						<div class="form-group">
								<textarea class="form-control" rows="6" placeholder="Description..." name="service_description"><?php echo $datas['description2']?></textarea>
							</div>
