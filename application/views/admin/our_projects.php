		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
					...
					<?php echo form_open_multipart('meta/insert_ourprojectsmeta/'); ?>
					<?php
					...
					<!--Main Banner of Our Projects Page Start Here-->
					<br><br><br><br><br><br><br><br><br><h2 class="pink-md-heading">Main Banner of Our Projects Page</h2>
					<?php echo form_open_multipart('pagesortingcontroller/projectmain/'); ?>
					<?php
			    		$data = $this->db->get('projecttop');
			    		$data = $data->result_array();
							foreach($data as $datas) {
		    		?>
					<div class="form-group">
						<input type="text" class="form-control" name="heading" placeholder="Enter Main Banner Heading Of Main Banner of Our Projects Page"  value="<?php echo $datas['heading']?>">
					</div>
					<div class="form-group">
						<textarea class="form-control" rows="6" placeholder="Enter Main Banner Description Of Our Projects Page Here" name="description"><?php echo $datas['description']?></textarea>
					</div>
					<button type="submit" name="submit" class="btn btn-primary">Submit</button>
					<?php
						}
					?>
					<?php echo form_close();?>
					<!--Main Banner of Our Projects Page End Here-->

					<!--Bottom Content of Our Projects Page Start Here-->
					<h2 class="pink-md-heading">Bottom Content of Our Projects Page</h2>
					<?php
			    		$data = $this->db->get('projectbottom');
			    		$data = $data->result_array();
							foreach($data as $datas) {
		    		?>
					<?php echo form_open_multipart('pagesortingcontroller/projectbottom/'); ?>
					<div class="form-group">
						<input type="text" class="form-control" name="heading" placeholder="Enter Bottom Content of Our Projects Page Heading Here" value="<?php echo $datas['heading']?>">
					</div>
					<div class="form-group">
						<textarea class="form-control" rows="6" placeholder="Enter Bottom Content of Our Projects Page Description Here" name="description"><?php echo $datas['description']?></textarea>
					</div>
					<button type="submit" name="submit" class="btn btn-primary">Submit</button>
					<?php
						}
					?>
					<?php echo form_close();?>
					<!--Bottom Content of Our Projects Page End Here-->
			</div>
			</div>
		</section>	
		<!-- header-ended -->
