		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
					<h2 class="pink-md-heading">Add service 3</h2>
					<?php echo form_open_multipart('adservicescontroller/insert3/'); ?>
						<?php
						...
						<div class="form-group">
							<input type="text" class="form-control" name="service_name" value="<?php echo $datas['name3']?>">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="service_subheading" value="<?php echo $datas['subheading3']?>">
						</div>
						<div class="form-group">
								<textarea class="form-control" rows="6" placeholder="Description..." name="service_description"><?php echo $datas['description3']?></textarea>
							</div>
